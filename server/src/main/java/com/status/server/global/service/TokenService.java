...
//    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000L * 60L * 30L;            // 30분
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000L * 60L * 2L;            // 2분 test
...
//        claims.put("emoji", emoji);
    ...
    public String getEmoji(String token) {
        return (String) Jwts.parser().setSigningKey(secretKey).parseClaimsJws(token).getBody().get("emoji");
    }
